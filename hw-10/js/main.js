...
const tableShowAllUsers = document.querySelector('.tableShowAllUsers');

//=====showUserId
const formUserID = document.querySelector('.search-user-id');
const showUserID = document.querySelector('.showUserID');
const inputID = document.querySelector( 'input[date-param="showId"]');
...
const inputName = document.querySelector( 'input[date-param="addName"]');
const inputAge = document.querySelector( '[date-param="addAge"]');
...
const inputRemoveID = document.querySelector( 'input[date-param="removeId"]');
const tableRemoveUserByID = document.querySelector('.tableRemoveUserByID');

// =====addUserIDName
const formUpdateIdName = document.querySelector('.update-by-id');
const update = document.querySelector('.update');
const updatedUsers = document.querySelector('.updatedUsers');
const inputNewName = document.querySelector( 'input[date-param="addNewName"]');
const inputNewAge = document.querySelector( '[date-param="addNewAge"]');
const inputUpdateID = document.querySelector( '[date-param="addId"]');
const tableUpdateId = document.querySelector('.tableUpdateId');
...
function removeUser(e) {
  ...
  .then(res => res.json())
  .then(date => 
    { if(date.status === 200) return alert('Success');
    })

...
class Hamburger {
   ...
   */
  addTopping(topping) {
    if (!this._toppings.some(val => val === topping)) {
  ...
  get calculatePrice() {
    return (
      ...
      this._toppings.reduce((acc, val) => acc + Hamburger.TOPPINGS[val].price, 0)
    );
  }
  ...
  get calculateCalories() {
    return (
      ...
      this._toppings.reduce((acc, val) => acc + Hamburger.TOPPINGS[val].calories, 0)
    );
  }
}
